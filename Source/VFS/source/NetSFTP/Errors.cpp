...
static constinit frozen::unordered_map<long, const char *, 81> g_Messages{
    ...
    {Errors::host_verification_failed, "The server's host key was not accepted."},
    {Errors::host_key_unavailable, "The server did not present a host key that could be verified."},
