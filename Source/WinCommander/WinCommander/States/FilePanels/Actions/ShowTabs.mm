...
static const auto g_ShowTitle = NSLocalizedString(@"Show Tab Bar", "Menu item title for showing tab bar");
static const auto g_HideTitle = NSLocalizedString(@"Hide Tab Bar", "Menu item title for hiding tab bar");

bool ShowTabs::ValidateMenuItem(MainWindowFilePanelState *_target, NSMenuItem *_item) const
{
    _item.title = GlobalConfig().GetBool(g_ConfigGeneralShowTabs) ? g_HideTitle : g_ShowTitle;
