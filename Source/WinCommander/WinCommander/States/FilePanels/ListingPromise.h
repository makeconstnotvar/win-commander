...
#include <WinCommander/Core/VFSInstancePromise.h>
#include <variant>
...
public:
    ...
    using VFSPromiseAdapter = std::function<core::VFSInstancePromise(const std::shared_ptr<VFSHost> &)>;
    using PromiseVFSAdapter = std::function<std::shared_ptr<VFSHost>(const core::VFSInstancePromise &)>;
...
bool operator==(const ListingPromise::UniformListing &_lhs, const ListingPromise::UniformListing &_rhs) noexcept;
bool operator!=(const ListingPromise::UniformListing &_lhs, const ListingPromise::UniformListing &_rhs) noexcept;
bool operator==(const ListingPromise::NonUniformListing &_lhs, const ListingPromise::NonUniformListing &_rhs) noexcept;
bool operator!=(const ListingPromise::NonUniformListing &_lhs, const ListingPromise::NonUniformListing &_rhs) noexcept;
