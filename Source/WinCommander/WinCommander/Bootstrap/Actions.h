...
static constexpr std::pair<const char*,int> g_ActionsTags[] = {
    {"menu.win_commander.about",                     10'000},
    {"menu.win_commander.preferences",               10'010},
    {"menu.win_commander.hide",                      10'020},
    {"menu.win_commander.hide_others",               10'030},
    {"menu.win_commander.show_all",                  10'040},
    {"menu.win_commander.quit",                      10'050},
    {"menu.win_commander.toggle_admin_mode",         10'070},
    {"menu.win_commander.active_license_file",       10'080}, // no longer used
    {"menu.win_commander.purchase_license",          10'090}, // no longer used
    {"menu.win_commander.purchase_pro_features",     10'100}, // no longer used
    {"menu.win_commander.restore_purchases",         10'110}, // no longer used
    {"menu.win_commander.registration_info",         10'120}, // no longer used
    ...
    {"menu.view.synchronize_directories",               13'300},
    {"menu.view.command_palette",                       13'310},
...
static constinit std::pair<const char*, const char*> g_DefaultActionShortcuts[] = {
    {"menu.win_commander.about",                         ""        },
    {"menu.win_commander.preferences",                   "⌘,"      }, // cmd+,
    {"menu.win_commander.toggle_admin_mode",             ""        },
    {"menu.win_commander.hide",                          "⌘h"      }, // cmd+h
    {"menu.win_commander.hide_others",                   "⌥⌘h"     }, // cmd+alt+h
    {"menu.win_commander.show_all",                      ""        },
    {"menu.win_commander.quit",                          "⌘q"      }, // cmd+q
    {"menu.win_commander.active_license_file",           ""        }, // no longer used
    {"menu.win_commander.purchase_license",              ""        }, // no longer used
    {"menu.win_commander.purchase_pro_features",         ""        }, // no longer used
    {"menu.win_commander.restore_purchases",             ""        }, // no longer used
    {"menu.win_commander.registration_info",             ""        }, // no longer used
...
//  {"menu.file.calculate_checksum",                        "⇧⌘k"     }, // shift+cmd+k, no longer used
    ...
    {"menu.view.synchronize_directories",                   ""        }, // Explorer dual pane only
    {"menu.view.command_palette",                           "⌥⌘k"     }, // alt+cmd+k
