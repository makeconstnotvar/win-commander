...
- Application-owned typed bound-plan review, presenter/coordinator composition and one bounded `CopyAs` mutation consumer are connected. Live app-boundary proof, physical-volume evidence and cross-volume staging remain separate gates.
