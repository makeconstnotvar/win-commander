...
tell application "System Events"
    tell application id "com.wincommander.App-Lite" to close every window
    tell application id "com.wincommander.App-Lite" to activate

    keystroke "n" using {command down} --> ⌘N - make new window
    delay 0.2

    set position of first window of application process "Duck Commander" to {100, 100}
    set size of first window of application process "Duck Commander" to {1220, 740}
    ...
    delay 0.5
    tell application id "com.wincommander.App-Lite"
...
tell application id "com.wincommander.App-Lite" to set windowID to id of window 1
